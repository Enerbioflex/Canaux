    ...
    <p class="diffusion">
        ...
        <span class="infoDiffusion">
            ...
            if($diffusion['auteurId'])
                echo '<a href="#">' . $diffusion['loginAuteur'] . '</a>';
            else
...
<form method="post" action="liste-diffusions.php">
    ...
    <p>
        <label for="lien">URL de la vidéo - <a href="aide.php">Aide pour l'obtenir</a></label>
        <input type="text" name="lien" id="lien" required />
    </p>

    <p>*L'année maximum selectionable est <?= $max ?> car vous serez mort d'ici la</p>
